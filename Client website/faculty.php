...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="images/faculty/ashley.jpg" alt="Jane">
      <div class="faculty">
        <h2>Ashley Jones</h2>
  ...
  <div class="column">
    <div class="card">
      <img src="images/faculty/don.jpg" alt="Mike">
     <div class="faculty">
        <h2>Data Scientist</h2>
        <p class="title">Don Francis</p>
        <p>Some text that describes me lorem ipsum ipsum lorem.</p>
        <p>example@example.com</p>
        <p><button class="button">Contact</button></p>
      </div>
  ...
  <div class="column">
    <div class="card">
      <img src="images/faculty/alexa.jpg" alt="John">
      <div class="faculty">
        <h2>Web Development</h2>
        <p class="title">Alexa Young</p>
        <p>Some text that describes me lorem ipsum ipsum lorem.</p>
        <p>example@example.com</p>
        <p><button class="button">Contact</button></p>
      </div>
  ...
  <div class="column">
    <div class="card">
      <img src="images/faculty/robert.jpg" alt="John">
     <div class="faculty">
        <h2>Networking</h2>
        <p class="title">Robert Rose</p>
        <p>Some text that describes me lorem ipsum ipsum lorem.</p>
        <p>example@example.com</p>
        <p><button class="button">Contact</button></p>
      </div>
  ...
  <div class="column">
    <div class="card">
      <img src="images/faculty/kevin.jpg" alt="John">
      <div class="faculty">
        <h2>Mobile App Development</h2>
        <p class="title">Kevin Nye</p>
        <p>Some text that describes me lorem ipsum ipsum lorem.</p>
        <p>example@example.com</p>
        <p><button class="button">Contact</button></p>
      </div>
  ...
  <div class="column">
    <div class="card">
      <img src="images/faculty/lisa.jpg" alt="John">
     <div class="faculty">
        <h2>Operating Systems</h2>
        <p class="title">Lisa Driver</p>
        <p>Some text that describes me lorem ipsum ipsum lorem.</p>
        <p>example@example.com</p>
        <p><button class="button">Contact</button></p>
      </div>
